...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "outnorth/debian-7RubyRailsDev"
  ...
  config.vm.network :forwarded_port, guest: 3035, host: 3035      # apache/nginx
  ...
  config.vm.synced_folder "~/code/server-promo/data", "/vagrant_data"
