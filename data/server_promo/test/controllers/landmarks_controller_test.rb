...
class LandmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landmark" do
    assert_difference('Landmark.count') do
      post landmarks_url, params: { landmark: { avatar: @landmark.avatar, description: @landmark.description, details: @landmark.details, title: @landmark.title } }
    end
  ...
  test "should update landmark" do
    patch landmark_url(@landmark), params: { landmark: { avatar: @landmark.avatar, description: @landmark.description, details: @landmark.details, title: @landmark.title } }
