class ArtifactsController < ApplicationController
  ...
  def new
    ...
    @artifact.projeto_id = params[:projeto_id]
  end
  ...
  def destroy
    @artifact.destroy
    respond_to do |format|
      format.html { redirect_to user_projeto_url(user_id: User.current_user_id, id: @artifact.projeto_id), notice: 'Artifact was successfully destroyed.' }
  ...
  private
    ...
    def artifact_params
      params.require(:artifact).permit(:name, :key, :projeto_id, :upload)
    end
end
